...
const WORDS = ["SOFTWARE ENGINEER", "UI & UX DESIGN"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Html & CSS"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/vrushabhhirpara" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/vrushabh-hirpara-0534b035a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
  { icon: Instagram, link: "https://www.instagram.com/mr_hirpara_.09?utm_source=qr&igsh=MXZ1bTg4OXZjZXc2cw==" }
];
